...
var factory_aleph_1 = require("./factory-aleph");
var factory_beth_1 = require("./factory-beth");
    ...
    AbstractFactory.createObject = function (factory) {
        try {
            if (['a-x', 'a-y', 'a-z'].indexOf(factory) > -1) {
                return factory_aleph_1.FactoryAleph.getObject(factory[2]);
            }
            if (['b-x', 'b-y', 'b-z'].indexOf(factory) > -1) {
                return factory_beth_1.FactoryBeth.getObject(factory[2]);
            }
