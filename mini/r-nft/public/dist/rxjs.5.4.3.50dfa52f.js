...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/rxjs.5.4.3.js":[function(require,module,exports) {
var define;
...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) : typeof define === 'function' && define.amd ? define(['exports'], factory) : factory(global.Rx = global.Rx || {});
  ...
  ***************************************************************************** */
  ...
  var _root = __window || __global || __self; // Workaround Closure Compiler restriction: The body of a goog.module cannot use throw.
  ...
  function symbolIteratorPonyfill(root$$1) {
    ...
    if (typeof _Symbol2 === 'function') {
      if (!_Symbol2.iterator) {
        _Symbol2.iterator = _Symbol2('iterator polyfill');
      }

      return _Symbol2.iterator;
    } else {
      ...
      var Map_1 = root$$1.Map; // required for compatability with es6-shim
  ...
  var FromObservable = function (_super) {
    ...
    FromObservable.create = function (ish, scheduler) {
      ...
      throw new TypeError((ish !== null && _typeof(ish) || ish) + ' is not observable');
    };
  ...
  */
  ...
  var ImmediateDefinition = function () {
    ...
    ImmediateDefinition.prototype.canUsePostMessage = function () {
      var root$$1 = this.root; // The test against `importScripts` prevents this implementation from being installed inside a web worker,
  ...
  var TestScheduler = function (_super) {
    ...
    TestScheduler.parseMarbles = function (marbles, values, errorValue, materializeInnerObservables) {
      ...
      var getValue = _typeof(values) !== 'object' ? function (x) {
        return x;
      } : function (x) {
...
},{}]},{},["../../../../../Users/thoma/AppData/Roaming/nvm/v10.16.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/rxjs.5.4.3.js"], null)
//# sourceMappingURL=/rxjs.5.4.3.50dfa52f.js.map