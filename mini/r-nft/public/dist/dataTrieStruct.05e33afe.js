...
var Trie = function Trie() {
  ...
  this.add = function (input) {
    ...
    if (input.length == 0) {
      // If no input,use this.root for node
      node.setEnd();
      return;
    } else if (!node.keys.has(input[0])) {
      // input.len > 0, there are more letters, but NOT YET AT END OF WORD
  ...
  this.isWord = function (word) {
    // checking if whole word in.. (doesn't check every word, only 1st letter )
    var node = this.root;
  ...
  this.print = function () {
    // helper fx:array of every word and searches 
    var words = new Array();

    var search = function search() {
      var node = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.root;
      var string = arguments.length > 1 ? arguments[1] : undefined;
...
},{}]},{},["../../../../../Users/thoma/AppData/Roaming/nvm/v10.16.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","dataStructures/dataTrieStruct.js"], null)
//# sourceMappingURL=/dataTrieStruct.05e33afe.js.map