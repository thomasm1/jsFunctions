...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"dataPerformance/bigO.js":[function(require,module,exports) {
console.log("%c big O Performance Timers", "color:white; background:red; :solid 1px blue"); // AUXILIARY SPACE COMPLEXITY: memory allocateD to run alg (not including input space)
...
console.log("FastTime O(1): ".concat((time2 - time1) / 1000, " seconds.")); ///  O(n)
...
console.log("SlowTime O(n): ".concat((t2 - t1) / 1000, " seconds.")); /// Quad  O(n^2)
...
console.log("Quad O(n^2): ".concat(((tt22 - tt11) / 1000).toPrecision(12), " seconds.")); //notQuad O(n)
...
console.log("notQuad O(n): ".concat(((tt2 - tt1) / 1000).toPrecision(12), " seconds.")); // LOGS:  Binary logarithm of a number is # of times you can divide by 2 before reaching <1.
...
},{}]},{},["../../../../../Users/thoma/AppData/Roaming/nvm/v10.16.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","dataPerformance/bigO.js"], null)
//# sourceMappingURL=/bigO.2d29df8b.js.map