...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"dataVisuals/dataQueues_D3.js":[function(require,module,exports) {
(vertiBars = function vertiBars() {
  var id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "appQueue";
  // d3 STACKS
  ...
  var XRP = 70.65,
      ...
      o = 111.33,
      p = 234.22;
  var data = [ETH, BTC, XRP, LTC, ETH, BTC, XRP, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p];

  function render(data) {
    var bars = d3.select(".appQueue").selectAll("div.h-bar").data(data); //UPDATE data

    bars // ENTER data
    .enter().append("div").attr("class", "h-bar").merge(bars) //Enter + Update data
...
},{}]},{},["../../../../../Users/thoma/AppData/Roaming/nvm/v10.16.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","dataVisuals/dataQueues_D3.js"], null)
//# sourceMappingURL=/dataQueues_D3.5d7228a1.js.map