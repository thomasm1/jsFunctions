...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"dataCalculators/searchDays.js":[function(require,module,exports) {
...
function binarySearch(array, val) {
  ...
  for (var i = 0; i < array.length; i++) {
    if (array[i] < val) {
      ...
      found = val;
      console.log("found it, profit ".concat(found, " is at index ").concat(i, " in array size: ").concat(array.length));
      return found;
    } else {
...
function fetchSortedBitcoin2019() {
  var bitcoinPromise, bitcoin2019, i;
  return regeneratorRuntime.async(function fetchSortedBitcoin2019$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          dailySorted = dailyProfitFull.sort(function (a, b) {
            return a - b;
          });
          ...
          return _context.abrupt("return", dailyLargest);
...
var awaitSearch = function awaitSearch() {
  var update;
  return regeneratorRuntime.async(function awaitSearch$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return regeneratorRuntime.awrap(fetchSortedBitcoin2019());
...
},{}]},{},["../../../../../Users/thoma/AppData/Roaming/nvm/v10.16.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","dataCalculators/searchDays.js"], null)
//# sourceMappingURL=/searchDays.f89b1b9e.js.map