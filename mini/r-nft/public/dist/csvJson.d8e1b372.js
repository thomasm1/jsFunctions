...
var _loop = function _loop(i) {
  var dc = 'dataConvert';
  document.getElementById(dc + i).innerHTML = "  \n  <h4>".concat(i === 0 ? 'Bitcoin' : i === 1 ? 'Ethereum' : 'Litecoin', " Daily Prices</h4>\n  <div class=\"").concat(dc + i, "\">\n  </div>  \n  ");

  function render(data) {
    d3.select(dcClass + i).append("pre").text(JSON.stringify(data, null, 2) + ',');
  }
  ...
  d3.csv("".concat(baseUrl).concat(coinArr[i]), type, render);
};
...
},{}]},{},["../../../../../Users/thoma/AppData/Roaming/nvm/v10.16.0/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","shared/csvJson.js"], null)
//# sourceMappingURL=/csvJson.d8e1b372.js.map