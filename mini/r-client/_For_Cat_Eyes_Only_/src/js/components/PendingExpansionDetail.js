...
export default class PendingExpandDetail extends React.Component {
      ...
      {!this.state.custodyListData||!this.state.gasMakeupData?<p>Loading...</p>:
        ...
        <div>
            <h3>Digital Feedstock ID: {this.props.detailFeedstockUID}</h3>
              ...
              <PendingTransactionDialog detailFeedstockStatus={this.props.detailFeedstockStatus} detailFeedstockUID={this.props.detailFeedstockUID} selectedTransactionUnits={this.state.selectedTransactionUnits} />
